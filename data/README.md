...
| `moltbook_posts_preprocessed.parquet` | Cleaned posts with text features, engagement scores, and engagement classes. Generated by `scripts/preprocess_engagement.py`. |
